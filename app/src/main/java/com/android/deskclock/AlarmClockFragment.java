...
public class AlarmClockFragment extends DeskClockFragment implements
    ...
    private void saveRingtoneUri(Intent intent) {
        ...
        // modily by quxiaobao from B8G merge  code start
        String tmpZIP =uri.toString().substring(uri.toString().lastIndexOf(".") + 1).toLowerCase();
        if(!"zip".equals(tmpZIP)) {
	   ...
	   // modily by quxiaobao from B8G merge  code end
    }
